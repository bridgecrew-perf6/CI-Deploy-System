 ...
 <input type="hidden" name="id" />
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="text" name="appName" id="appName" value="${appName}" readonly="readonly" lay-verify="required" placeholder="请选择应用" autocomplete="off" class="layui-input">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="text" name="configName" lay-verify="required" placeholder="请输入配置名称" class="layui-input">
		</div>
	</div>
