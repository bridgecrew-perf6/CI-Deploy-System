						...
						var h = [],
							f = [{
								...
								tooltip: {
									trigger: "axis",
									formatter: function(e) {
										return e[0].name + "<br/>" + e[0].seriesName + " : " + e[0].value + " (m^3/s)<br/>" + e[1].seriesName + " : " + -e[1].value + " (mm)"
									}
								},
								legend: {
									data: ["流量", "降雨量"],
