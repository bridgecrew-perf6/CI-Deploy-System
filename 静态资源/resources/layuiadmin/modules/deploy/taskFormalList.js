...
function(t) {
    ...
    i.render({
        ...
        url: "/deploy/task/formal/listdata",
        method: 'post',
    ...
    function(t) {
        ...
        if ("rollback" === t.event) {
            layer.confirm("确定要回滚到此次部署吗？",
            function(e) {
                $.ajax({
                    type: "POST",
                    url: "/deploy/task/formal/rollback",
                    data: {
                    	taskId: id
                    },
                    dataType: "json"
